...
const OtpField = ({
    ...
    const slotGroups = Array.from({ length: Math.ceil(slots.length / groupSize) }, (_, index) =>
        slots.slice(index * groupSize, index * groupSize + groupSize),
    );
                                ...
                                return (
                                    <Fragment key={idx}>
                                        <InputOTPGroup>
                                            {slotGroup.map((index) => (
                                                <InputOTPSlot
                                                    className={cn(field.value && "font-semibold", className)}
