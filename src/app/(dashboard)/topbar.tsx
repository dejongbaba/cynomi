...
import {RiArrowDropDownLine, RiLogoutBoxRLine, RiNotification3Line,} from "@remixicon/react";
...
export default function Component() {
    ...
    return (
        <div
            className=" h-fit flex  rounded-lg bg-white border border-neutral-200 transition-all  inset-x-0  w-[95%] mx-auto my-6 sticky ">
                    ...
                    <Popover className="relative w-full z-50">
                        {({open}) => {
                            return (
                                <>
                                    <Popover.Button
                                        className="p-2 rounded-lg hover:bg-accent ui-open:bg-bg-accent outline-primary-400">
                            ...
                            return (
                                <>
                                    ...
                                    >
                                        ...
                                        <RiArrowDropDownLine
                                            className="h-6 w-6 ui-open:rotate-180 ui-open:transform ui-open:duration-200"/>
                                    </Popover.Button>
                                    <Transition
                                        show={open}
                                        enter="transition ease-out duration-200"
